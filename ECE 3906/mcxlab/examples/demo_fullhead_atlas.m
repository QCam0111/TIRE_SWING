...
% cfg.prop=[0.000,0.000,1.000,1.000;  % ambient air
%     0.00168 9.000 0.800 1.370;        % scalp
%     0.00104 14.6364 0.890 1.370;      % skull
%     0.0144 0.0909 0.890 1.370;      % csf
%     0.00502 5.900 0.910 1.370;        % gray matter
%     0.00752 30.00 0.880 1.370;        % white matter
%     0.000 0.000 1.000 1.370];       % air cavities

% [mua, mus, g, n] n= index of refraction
% %1550nm simulation parameters
cfg.prop=[0.000,0.000,1.000,1.000;  % ambient air
    0.01649 9.000 0.800 1.370;        % scalp
    0.02715 14.6364 0.890 1.370;      % skull
    0.0144 0.0909 0.890 1.370;      % csf
    0.03071 5.900 0.910 1.370;        % gray matter
    0.03353 30.00 0.880 1.370;        % white matter
    0.000 0.000 1.000 1.370];       % air cavities
...
% light source
cfg.srcnum=1;
cfg.srcpos=[164,90.1988,119]; %pencil beam source placed at EEG 10-5 landmark:"C4h"
% cfg.srcpos=[86,90.1988,219]; %pencil beam source placed at approximated CZ location
cfg.srctype='disk';
% cfg.srctype='planar';
% cfg.srcpos=[10 10 0];
